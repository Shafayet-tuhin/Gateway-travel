...
const AllBookings = () => {
  ...
  return (
    <div className="p-4">
      ...
      <table className="min-w-fullshadow-md rounded-lg overflow-hidden mt-4">
        <thead>
        ...
        <tbody>
          {bookings.map((booking) => (
            <tr key={booking._id} className="border-b text-gray-200">
             <td className="py-3 px-6"><img src={booking.placeImg[0]} className='w-12 rounded-3xl h-12' alt="" /></td>
